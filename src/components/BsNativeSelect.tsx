...
export function BsNativeSelect({
  ...
  return (
    <label className={cn("relative inline-flex shrink-0", className)}>
      ...
      <span
        className="pointer-events-none flex h-6 w-full min-w-0 items-center justify-between gap-0.5 rounded-md border border-border bg-card px-1 text-sm font-medium text-foreground sm:h-7 sm:gap-1 sm:px-1.5 sm:text-xs"
        aria-hidden
      >
