    ...
    <DrawerPortal>
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          ...
          "data-[vaul-drawer-direction=right]:inset-y-0 data-[vaul-drawer-direction=right]:right-0 data-[vaul-drawer-direction=right]:h-full data-[vaul-drawer-direction=right]:w-[min(85vw,400px)] data-[vaul-drawer-direction=right]:border-l data-[vaul-drawer-direction=right]:shadow-xl",
          "data-[vaul-drawer-direction=left]:inset-y-0 data-[vaul-drawer-direction=left]:left-0 data-[vaul-drawer-direction=left]:h-full data-[vaul-drawer-direction=left]:w-[min(85vw,400px)] data-[vaul-drawer-direction=left]:border-r data-[vaul-drawer-direction=left]:shadow-xl",
          className,
        )}
        {...props}
      >
