...
export const SAIT_RULES_CONTENT: Record<SaitCategoryId, SaitContent> = {
  ...
  "byaparik-pratisthan": {
    ...
    method: DAYTIME_INTRO,
    rules: [
      { ne: "महिना — अधिकमास बाहेक सबै चन्द्रमास; संक्रान्तिको दिन वर्जित।", en: "Month — all lunar months except Adhik-māsa; Sankrānti days barred." },
      { ne: "तिथि — शुक्ल २,३,५,७,१०,११,१३,१५ वा कृष्ण २,३,५,७,१०,११,१३।", en: "Tithi — śukla 2,3,5,7,10,11,13,15 or kṛṣṇa 2,3,5,7,10,11,13." },
      { ne: "नक्षत्र — व्यापारका लागि उपयुक्त १६ नक्षत्र (स्थिर/चर/मृदु/क्षिप्र)।", en: "Nakṣatra — the 16 approved for trade (sthira/chara/mṛdu/kṣipra)." },
      { ne: "वार — सोम, बुध, बिहि, शुक्र मात्र (आइत/मंगल/शनि वर्जित); दिनको समय मात्र।", en: "Vāra — only Mon/Wed/Thu/Fri (Sun/Tue/Sat barred); daytime only." },
      { ne: "ग्रह — गुरु र शुक्र अस्त हुनुहुँदैन; ग्रहण ±३ दिन वर्जित।", en: "Graha — Jupiter & Venus must be udaya; eclipse ±3 days excluded." },
    ],
  },
  "rudri-jurne": {
    description: {
