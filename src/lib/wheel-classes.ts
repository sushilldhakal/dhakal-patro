...
export const wheelHeadEyebrow =
  "text-[10px] font-semibold uppercase tracking-[0.16em] text-[var(--w-ink-faint)]";

export const wheelHeadTitle =
  "mt-1.5 text-[26px] font-bold leading-tight text-[var(--w-ink)] max-[720px]:text-xl [&_.yr]:font-num [&_.yr]:text-[var(--w-accent)]";
...
export const wheelTipKind =
  "text-[9.5px] font-semibold uppercase tracking-[0.12em] text-[var(--w-accent)]";
...
export const wheelTipSym =
  "mt-1 text-[12.5px] font-normal text-[var(--w-ink-dim)]";
...
export const wheelPanelGlyph =
  "w-14 shrink-0 text-center text-[46px] leading-none text-[var(--w-ink)]";

export const wheelPanelKind =
  "text-[10px] font-semibold uppercase tracking-[0.14em] text-[var(--w-accent)]";
...
export const wheelDlV =
  "whitespace-nowrap text-right text-[13px] font-semibold text-[var(--w-ink)]";
...
export const wheelPanelConsTxt =
  "w-full font-num text-[11px] font-medium leading-normal text-[var(--w-ink-dim)] [&_b]:mb-0.5 [&_b]:block [&_b]:text-xs [&_b]:font-semibold [&_b]:text-[var(--w-ink)]";
