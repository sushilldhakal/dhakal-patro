/**
 * Long-form bilingual explanations for each standalone panchanga-element page.
 *
 * Rendered at the bottom of {@link ElementPage} so every element documents, in
 * both Nepali and English: what it is, how it is calculated, and what it means.
 * Keyed by the same element id as {@link ELEMENT_META}.
 */
...
export interface ElementDescription {
  /** What the element is. */
  what: BilingualText;
  /** How it is computed from the ephemeris. */
  how: BilingualText;
...
export const ELEMENT_DESCRIPTIONS: Record<string, ElementDescription> = {
  ...
  yoga: {
    ...
    meaning: {
      ...
      en: "Some yogas are auspicious (Siddhi, Amrita) and some malefic (Vyatipata, Vaidhriti, the opening of Vishkumbha). Yoga is one of the five limbs of the panchanga checked when choosing a muhurta.",
    },
  },
  karana: {
    what: {
